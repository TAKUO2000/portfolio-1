        ...
        <div class="flex flex-wrap -m-4">
            <div class="p-4 w-full lg:w-1/3 hover:bg-gray-300 rounded-lg">
                <div class="h-full bg-gray-300 bg-opacity-75 px-8 py-16 rounded-lg overflow-hidden text-center relative">
                    ...
                    <br>
                    <a class="text-indigo-500 inline-flex items-center p-2 hover:text-indigo-900" href ="{{ route('order.employee') }}">従業員用ページ
            ...
            <div class="p-4 w-full lg:w-1/3  hover:bg-gray-300 rounded-lg">
                ...
                <a class="text-indigo-500 inline-flex items-center p-2 hover:text-indigo-900"  href ="{{ route('order_status.employee') }}">従業員用ページ
            ...
            <div class="p-4 w-full lg:w-1/3 hover:bg-gray-300 rounded-lg">
                <div class="h-full bg-gray-300 bg-opacity-75 px-8 py-16 rounded-lg overflow-hidden text-center relative">
                    ...
                    <div class = "my-auto">
                        <a class="text-indigo-500 inline-flex items-center p-2 hover:text-indigo-900" href="{{ route('mgmt.menus') }}">管理者用ページ
                            <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M5 12h14"></path>
                            <path d="M12 5l7 7-7 7"></path>
                            </svg>
